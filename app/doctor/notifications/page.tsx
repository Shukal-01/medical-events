...
import { Bell, Calendar, Info, AlertCircle, CheckCircle, Users } from "lucide-react"
...
const notifications = [
  {
    id: "1",
    title: "New booking",
    description: "John Smith has booked your Cardiology Conference.",
  ...
  },
  {
    ...
    description: "Your Cardiology Conference is scheduled for tomorrow at 9:00 AM.",
  ...
  },
  {
    ...
    description: "You received a payment of $150 for Cardiology Conference booking.",
    date: "2025-04-10T09:16:00",
    type: "payment",
    isRead: true,
  },
  {
    ...
    description: "Your Health Seminar has reached full capacity (120/120 bookings).",
